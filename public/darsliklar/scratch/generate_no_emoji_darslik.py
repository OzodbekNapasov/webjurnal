...
<head>
  ...
  <meta name="description" content="Tibbiyotda Axborot Texnologiyalari fani bo'yicha 'Google tomonidan ishlab chiqarilgan dasturlar' interaktiv elektron darsligi.">
  <meta name="keywords" content="Google, Tibbiyotda IT, Google Workspace, Google Docs, Google Sheets, Google Drive, Telemeditsina, Analoglar, MS Office">
  <meta name="author" content="Tibbiyotda Axborot Texnologiyalari Metodisti">
  <title>Google Dasturlari va Ularning Analoglari - Tibbiyotda IT</title>
...
<body>
  ...
  <header class="app-header">
    ...
    <ul class="nav-links">
      ...
      <li><a href="#tahlil-dasturlar" class="nav-link">Dasturlar & Analoglar</a></li>
  ...
  <main class="landing-container">
    ...
    <section class="hero-section" id="kirish">
      ...
      <h1 class="hero-title">Google tomonidan ishlab chiqarilgan dasturlar va ularning analoglari</h1>
      <p class="hero-subtitle">Google Workspace bulutli ilovalari, ularning ish stoli (desktop) analoglari (MS Office, Zoom, OneDrive) hamda tibbiy amaliyotdagi batafsil roli haqida interaktiv darslik.</p>
      ...
      <div class="stats-strip">
        ...
        <div class="stat-card">
          <div class="stat-num">8+</div>
          <div class="stat-label">Desktop & Offline Analoglar</div>
        </div>
        <div class="stat-card">
      ...
      <div class="grid-2">
        <div class="glass-card">
          ...
          <ul class="custom-list">
            ...
            <li><strong>Bulut va Analoglar qiyoslashi:</strong> Har bir Google xizmatini MS Office va boshqa ish stoli dasturlari bilan taqqoslash.</li>
        ...
        <div class="glass-card" style="align-items:center; justify-content:center; text-align:center; background:linear-gradient(135deg, rgba(14,165,233,0.1), rgba(16,185,129,0.1));">
          <div style="display:flex; flex-direction:column; gap:16px; width:100%; max-width:340px;">
            ...
            <div style="padding:14px; background:rgba(255,255,255,0.05); border:1px solid var(--med-green); border-radius:12px; font-weight:700;">2. Amaliy Ko'nikma va Analoglar</div>
    ...
    <section class="section-block" id="workspace">
      <div class="section-badge">
        ...
        3-Bo'lim: Google Workspace Umumiy Qarash
      </div>
      <h2 class="section-title">
        ...
        Google Workspace Dasturlari Umumiy Ro'yxati
      </h2>
      <div class="grid-4">
        <!-- Docs -->
        <div class="glass-card">
        ...
        <div class="glass-card">
          <div class="card-icon" style="background:rgba(52,168,83,0.15); color:var(--g-green);">
            <svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 3v3h-7V6h7zm-8 0v3H5V6h6zm-6 5h6v3H5v-3zm8 0h7v3h-7v-3zm7 8h-7v-3h7v3zm-8 0H5v-3h6v3z"/></svg>
          </div>
        ...
        <div class="glass-card">
          <div class="card-icon" style="background:rgba(251,188,5,0.15); color:var(--g-yellow);">
            <svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 14H5V5h14v12z"/></svg>
          </div>
          <div class="card-title">Google Slides</div>
          <div class="card-desc">Interaktiv taqdimotlar va ilmiy ma'ruzalar tayyorlash.</div>
          <div class="analog-badge">
            <svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"/></svg>
            MS PowerPoint Analog
          </div>
          <div class="med-tag">
            <svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-1.99.9-1.99 2L3 19c0 1.1.89 2 1.99 2H19c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-1 11h-4v4h-4v-4H6v-4h4V6h4v4h4v4z"/></svg>
            Tibbiy ma'ruzalar
        ...
        <div class="glass-card">
          <div class="card-icon" style="background:rgba(168,85,247,0.15); color:var(--g-purple);">
            <svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 14H7v-2h5v2zm4-4H7v-2h9v2zm0-4H7V7h9v2z"/></svg>
          </div>
        ...
        <div class="glass-card">
          <div class="card-icon" style="background:rgba(66,133,244,0.15); color:var(--g-blue);">
            <svg viewBox="0 0 24 24"><path d="M7.71 3.5L1.15 15l3.43 6 6.56-11.5H7.71zM9.73 15L6.3 21h13.12l3.43-6H9.73zm6.56-11.5L9.73 15h13.12l6.56-11.5H16.29z"/></svg>
          </div>
    ...
    <!-- SECTION 5: HAR BIR DASTUR CHUQUR TAHLILI VA ANALOGLARI -->
    <section class="section-block" id="tahlil-dasturlar">
      <div class="section-badge">
        <svg viewBox="0 0 24 24"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>
        4-Bo'lim: Har bir dastur bo'yicha batafsil tushuntirish va analoglar
      </div>
      <h2 class="section-title">
        <svg viewBox="0 0 24 24" fill="none" stroke="var(--med-blue)" stroke-width="2"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>
        Google Dasturlari va Ularning Analoglari (Solishtirma Tahlil)
      </h2>
      ...
      <div style="display:flex; flex-direction:column; gap:2rem;">
        ...
        <div class="glass-card" style="border-left:4px solid var(--g-blue);">
          <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px;">
            <div class="card-title" style="color:var(--g-blue); font-size:1.3rem; display:flex; align-items:center; gap:10px;">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="var(--g-blue)"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>
              1. Google Docs (Matn Hujjatlari)
            </div>
            <div class="analog-badge">Ish Stoli (Desktop) Analog: Microsoft Word / LibreOffice Writer</div>
          </div>
          <div class="grid-2">
            <div>
              <h4 style="color:var(--text-primary); margin-bottom:8px;">📌 Dastur Haqida va Hususiyatlari:</h4>
              <p class="card-desc">Google Docs — bu bulutda ishlaydigan bepul matn muharriri. U kompyuterga hech qanday dastur o'rnatmasdan brauzer orqali ishlaydi. Eng katta ustunligi real vaqtda bir nechta shifokorlarning bitta hujjat ustida tahrir olib borishi (co-authoring) hamda o'zgarishlar tarixini (Version History) avtomatik saqlashidir.</p>
              <h4 style="color:var(--text-primary); margin:12px 0 6px 0;">⚡ MS Word bilan solishtirish:</h4>
              <p class="card-desc">MS Word litsenziya va kompyuterga o'rnatishni talab etadi hamda faylni fleshka yoki telegram orqali bir-biriga yuborishga majbur qiladi. Google Docs esa internet orqali bitta havola bilan kirib birgalikda tahrirlash imkonini beradi.</p>
            </div>
            <div>
              <h4 style="color:var(--med-green); margin-bottom:8px;">🏥 Tibbiyotdagi Amaliy Misollar:</h4>
              <ul class="custom-list">
                <li><strong>Kasallik Tarixini Yozish (Epicrisis):</strong> Bir nechta mutaxassis shifokorlar (jarroh, terapevt, kardiolog) bemor kasallik tarixini bir vaqtning o'zida to'ldiradi.</li>
                <li><strong>Shifokor Hisobotlari:</strong> Bo'lim mudiri va shifokorlar oylik hamda yillik tibbiy hisobotlarni birgalikda tayyorlaydi.</li>
                <li><strong>Davolash Rejalari & PDF:</strong> Murakkab operatsiya protokollarini tasdiqlab, darhol PDF shaklida chop etadi.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <!-- 2. GOOGLE SHEETS -->
        <div class="glass-card" style="border-left:4px solid var(--g-green);">
          <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px;">
            <div class="card-title" style="color:var(--g-green); font-size:1.3rem; display:flex; align-items:center; gap:10px;">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="var(--g-green)"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 3v3h-7V6h7zm-8 0v3H5V6h6zm-6 5h6v3H5v-3zm8 0h7v3h-7v-3zm7 8h-7v-3h7v3zm-8 0H5v-3h6v3z"/></svg>
              2. Google Sheets (Elektron Jadvallar)
            </div>
            <div class="analog-badge">Ish Stoli (Desktop) Analog: Microsoft Excel / Apple Numbers</div>
          </div>
          <div class="grid-2">
            <div>
              <h4 style="color:var(--text-primary); margin-bottom:8px;">📌 Dastur Haqida va Hususiyatlari:</h4>
              <p class="card-desc">Google Sheets — bu bulutli elektron jadval dasturi. U murakkab matematik, statistik va mantiqiy formulalar (SUM, AVERAGE, VLOOKUP, COUNTIF) bilan ishlash, doiraviy hamda ustunli grafiklar chizish va ma'lumotlarni saralash imkonini beradi.</p>
              <h4 style="color:var(--text-primary); margin:12px 0 6px 0;">⚡ MS Excel bilan solishtirish:</h4>
              <p class="card-desc">MS Excel murakkab makroslar va ulkan makro-fayllar uchun kuchli bo'lsa-da, Google Sheets Google Forms anketalari natijalarini avtomatik jadvalga yig'ishi va bir nechta xodimlar bir vaqtda jadval to'ldirishi bo'yicha ancha qulaydir.</p>
            </div>
            <div>
              <h4 style="color:var(--med-green); margin-bottom:8px;">🏥 Tibbiyotdagi Amaliy Misollar:</h4>
              <ul class="custom-list">
                <li><strong>Bemorlar Reyestri:</strong> Bo'limdagi barcha bemorlarning yoshi, kasalligi va harorati dinamikasini yuritish.</li>
                <li><strong>Laboratoriya Natijalari:</strong> Qon va siydik analizi ko mezonlarini formulalar orqali me'yoriy ko'rsatkichlar bilan solishtirish.</li>
                <li><strong>Tibbiy Statistika:</strong> Kasallanish darajasi hamda emlash qamrovini avtomatik grafikda tasvirlash.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="glass-card" style="border-left:4px solid var(--g-yellow);">
          <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px;">
            <div class="card-title" style="color:var(--g-yellow); font-size:1.3rem; display:flex; align-items:center; gap:10px;">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="var(--g-yellow)"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 14H5V5h14v12z"/></svg>
              3. Google Slides (Interaktiv Taqdimotlar)
            </div>
            <div class="analog-badge">Ish Stoli (Desktop) Analog: Microsoft PowerPoint / Apple Keynote</div>
          </div>
          <div class="grid-2">
            <div>
              <h4 style="color:var(--text-primary); margin-bottom:8px;">📌 Dastur Haqida va Hususiyatlari:</h4>
              <p class="card-desc">Google Slides — bu ko'rgazmali interaktiv taqdimotlar va ilmiy slaydlar yaratish servisi. U tayyor shablonlar, animatsiyalar va multimedia (videolar, SVG grafiklar) bilan ishlashni ta'minlaydi.</p>
              <h4 style="color:var(--text-primary); margin:12px 0 6px 0;">⚡ MS PowerPoint bilan solishtirish:</h4>
              <p class="card-desc">PowerPoint kompyuter xotirasiga bog'langan bo'lsa, Google Slides havola orqali har qanday kompyuter, planshet yoki smartfondan brauzerda zudlik bilan namoyish etilishi mumkin.</p>
            </div>
            <div>
              <h4 style="color:var(--med-green); margin-bottom:8px;">🏥 Tibbiyotdagi Amaliy Misollar:</h4>
              <ul class="custom-list">
                <li><strong>Tibbiy Ma'ruzalar:</strong> Tibbiyot akademiyasi talabalariga anatomiya va patologiya ma'ruzalarini ko'rgazmali namoyish etish.</li>
                <li><strong>Ilmiy Konferensiyalar:</strong> Tibbiy tadqiqotlar va yangi dori vositalari sinovlari natijalarini slayd shaklida ko'rsatish.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="glass-card" style="border-left:4px solid var(--g-purple);">
          <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px;">
            <div class="card-title" style="color:var(--g-purple); font-size:1.3rem; display:flex; align-items:center; gap:10px;">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="var(--g-purple)"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 14H7v-2h5v2zm4-4H7v-2h9v2zm0-4H7V7h9v2z"/></svg>
              4. Google Forms (Onlayn Anketalar)
            </div>
            <div class="analog-badge">Onlayn Analog: SurveyMonkey / Typeform / MS Forms</div>
          </div>
          <div class="grid-2">
            <div>
              <h4 style="color:var(--text-primary); margin-bottom:8px;">📌 Dastur Haqida va Hususiyatlari:</h4>
              <p class="card-desc">Google Forms — onlayn so'rovnomalar, anketalar va avtomatik ball hisoblaydigan imtihon testlarini yaratish servisi. U tushgan javoblarni real vaqtda doiraviy (pie chart) va ustunli grafiklarda tahlil etib beradi.</p>
              <h4 style="color:var(--text-primary); margin:12px 0 6px 0;">⚡ SurveyMonkey / Typeform bilan solishtirish:</h4>
              <p class="card-desc">SurveyMonkey kabi pullik servislardan farqli ravishda Google Forms 100% bepul, so'rovnomalar va responslar soniga cheklov qo'ymaydi hamda Google Sheets bilan to'g'ridan-to'g'ri integratsiyalangan.</p>
            </div>
            <div>
              <h4 style="color:var(--med-green); margin-bottom:8px;">🏥 Tibbiyotdagi Amaliy Misollar:</h4>
              <ul class="custom-list">
                <li><strong>Bemorlarni Onlayn Ro'yxatdan O'tkazish:</strong> Qabulga yozilish va birlamchi shikoyatlarni yig'ish.</li>
                <li><strong>Anonim So'rovnomalar:</strong> Shifoxona xizmat ko'rsatish sifatini oshirish uchun bemorlardan feedback yig'ish.</li>
                <li><strong>Shifokorlar Imtihoni:</strong> Tibbiyot xodimlarining malakasini sinash uchun avtomatik testlar.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="glass-card" style="border-left:4px solid var(--g-blue);">
          <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px;">
            <div class="card-title" style="color:var(--g-blue); font-size:1.3rem; display:flex; align-items:center; gap:10px;">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="var(--g-blue)"><path d="M7.71 3.5L1.15 15l3.43 6 6.56-11.5H7.71zM9.73 15L6.3 21h13.12l3.43-6H9.73zm6.56-11.5L9.73 15h13.12l6.56-11.5H16.29z"/></svg>
              5. Google Drive (Bulutli Xotira)
            </div>
            <div class="analog-badge">Bulutli Analog: Microsoft OneDrive / Dropbox / Yandex Disk</div>
          </div>
          <div class="grid-2">
            <div>
              <h4 style="color:var(--text-primary); margin-bottom:8px;">📌 Dastur Haqida va Hususiyatlari:</h4>
              <p class="card-desc">Google Drive — bu har bir foydalanuvchiga 15 GB bepul joy beradigan bulutli saqlash va zaxiralash (Backup) diski. U fayllarga masofadan kirish hamda ruxsatlarni (Viewer, Editor) sozlash imkonini beradi.</p>
              <h4 style="color:var(--text-primary); margin:12px 0 6px 0;">⚡ OneDrive va Dropbox bilan solishtirish:</h4>
              <p class="card-desc">OneDrive 5 GB bepul joy bergani holda, Google Drive 15 GB joy beradi hamda Google Docs/Sheets/Forms bilan 100% ichki bog'lanishga ega.</p>
            </div>
            <div>
              <h4 style="color:var(--med-green); margin-bottom:8px;">🏥 Tibbiyotdagi Amaliy Misollar:</h4>
              <ul class="custom-list">
                <li><strong>Rentgen, MRT va KT Tasvirlari:</strong> Katta hajmdagi raqamli tibbiy tasvirlarni bulutda havfsiz saqlash.</li>
                <li><strong>Laboratoriya Hujjatlari Arxivi:</strong> Bemorlarning o'tgan yillardagi tahlil natijalarini zudlik bilan topish.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="glass-card" style="border-left:4px solid var(--g-red);">
          <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px;">
            <div class="card-title" style="color:var(--g-red); font-size:1.3rem; display:flex; align-items:center; gap:10px;">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="var(--g-red)"><path d="M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.5l4 4v-11l-4 4z"/></svg>
              6. Google Meet (Videokonferensiya)
            </div>
            <div class="analog-badge">Onlayn Analog: Zoom / Microsoft Teams / Skype</div>
          </div>
          <div class="grid-2">
            <div>
              <h4 style="color:var(--text-primary); margin-bottom:8px;">📌 Dastur Haqida va Hususiyatlari:</h4>
              <p class="card-desc">Google Meet — bu yuqori sifatli HD videokonferensiyalar o'tkazish servisi. U ekranni namoyish etish (Screen Share), shovqinni kamaytirish va shifrlangan xavfsiz kanallar bilan ta'minlangan.</p>
              <h4 style="color:var(--text-primary); margin:12px 0 6px 0;">⚡ Zoom va MS Teams bilan solishtirish:</h4>
              <p class="card-desc">Zoom ilovasi qo'shimcha dastur yuklab olishni va muntazam yangilashni talab etadi. Google Meet esa to'g'ridan-to'g'ri brauzer orqali yoki Google Calendar havolasi bilan bir bosishda ishga tushadi.</p>
            </div>
            <div>
              <h4 style="color:var(--med-green); margin-bottom:8px;">🏥 Tibbiyotdagi Amaliy Misollar:</h4>
              <ul class="custom-list">
                <li><strong>Telemeditsina Konsultatsiyasi:</strong> Shifokor va bemor o'rtasidagi masofaviy vizual ko'rik.</li>
                <li><strong>Tibbiy Konsiliumlar:</strong> Respublika va viloyat markazi shifokorlarining murakkab operatsiyadan oldingi masofaviy majlisi.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="glass-card" style="border-left:4px solid var(--g-blue);">
          <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px;">
            <div class="card-title" style="color:var(--g-blue); font-size:1.3rem; display:flex; align-items:center; gap:10px;">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="var(--g-blue)"><path d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10zm0-12H5V6h14v2z"/></svg>
              7. Google Calendar (Taqvim va Rejalashtirish)
            </div>
            <div class="analog-badge">Ish Stoli Analog: Microsoft Outlook Calendar / Apple Calendar</div>
          </div>
          <div class="grid-2">
            <div>
              <h4 style="color:var(--text-primary); margin-bottom:8px;">📌 Dastur Haqida va Hususiyatlari:</h4>
              <p class="card-desc">Google Calendar — bu vaqtni rejalashtirish va elektron taqvim tizimi. U uchrashuv va qabullarni belgilash, avtomatik SMS hamda E-mail eslatmalar yuborish funksiyalariga ega.</p>
              <h4 style="color:var(--text-primary); margin:12px 0 6px 0;">⚡ MS Outlook Calendar bilan solishtirish:</h4>
              <p class="card-desc">Outlook korporativ serverlarga bog'liq bo'lsa, Google Calendar shaxsiy va jamoaviy smartfonlar bilan avtomatik sinxronlanib turadi.</p>
            </div>
            <div>
              <h4 style="color:var(--med-green); margin-bottom:8px;">🏥 Tibbiyotdagi Amaliy Misollar:</h4>
              <ul class="custom-list">
                <li><strong>Shifokor Qabul Vaqtlari:</strong> Bemorlarning uchrashuv vaqtlarini rejalashtirish va SMS eslatma yuborish.</li>
                <li><strong>Navbatchilik Smena Jadvali:</strong> Tibbiyot xodimlarining tuni va kunduzgi navbatchiliklarini taqvimda ko'rsatish.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="glass-card" style="border-left:4px solid var(--g-yellow);">
          <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px;">
            <div class="card-title" style="color:var(--g-yellow); font-size:1.3rem; display:flex; align-items:center; gap:10px;">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="var(--g-yellow)"><path d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7z"/></svg>
              8. Google Keep (Tezkor Eslatmalar)
            </div>
            <div class="analog-badge">Ish Stoli Analog: Microsoft OneNote / Evernote / Apple Notes</div>
          </div>
          <div class="grid-2">
            <div>
              <h4 style="color:var(--text-primary); margin-bottom:8px;">📌 Dastur Haqida va Hususiyatlari:</h4>
              <p class="card-desc">Google Keep — bu tezkor matnli, ovozli va rasmli eslatmalar hamda topshiriqlar ro'yxatini (Checklist) yuritish servisi. U stikerlar ko'rinishidagi yengil dizaynga ega.</p>
              <h4 style="color:var(--text-primary); margin:12px 0 6px 0;">⚡ MS OneNote / Evernote bilan solishtirish:</h4>
              <p class="card-desc">OneNote va Evernote murakkab daftarlar va katta hujjatlar uchun mos keladi. Google Keep esa bir necha soniya ichida tezkor qaydlarni yozib olish va ularga eslatma vaqti qo'yish uchun juda engildir.</p>
            </div>
            <div>
              <h4 style="color:var(--med-green); margin-bottom:8px;">🏥 Tibbiyotdagi Amaliy Misollar:</h4>
              <ul class="custom-list">
                <li><strong>Dori Qabul Qilish Eslatmalari:</strong> Bemorlarga dori preparatlarini qaysi soatda ichish topshirig'i.</li>
                <li><strong>Kunlik Shifokor Ko'rigi:</strong> Palatadagi bemorlarni ko'zdan kechirish va topshiriqlarni belgilab borish.</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <section class="section-block" id="tahlil">
      ...
      <h2 class="section-title">
        ...
        Google Servislarining Afzalliklari va Kamchiliklari
      </h2>
      <div class="grid-2">
    ...
    <section class="section-block" id="amaliyot">
      ...
      <div class="glass-card">
        ...
        <div id="taskStatusText" style="font-weight:700; color:var(--med-green); margin-top:10px; display:none; display:flex; align-items:center; gap:8px;">
    ...
    <!-- SECTION 8: MUSTAHKAMLASH SAVOLLARI -->
    ...
    <section class="section-block" id="xulosa">
      ...
      <div class="grid-2">
        ...
        <div class="glass-card" style="border-color:var(--med-green); text-align:center; align-items:center; justify-content:center;">
          <div style="width:60px; height:60px; border-radius:50%; background:rgba(16,185,129,0.15); display:flex; align-items:center; justify-content:center; color:var(--med-green); margin-bottom:10px;">
          ...
          <div class="card-desc">Google Dasturlari va Ularning Analoglari bo'yicha elektron darslikni muvaffaqiyatli o'zlashtirdingiz.</div>
  ...
  <div class="modal-overlay" id="searchModal">
    <div class="modal-box">
      ...
      <input type="text" class="search-input" id="searchInput" placeholder="Qidiruv so'zini kiriting (Forms, Meet, Drive, Word, Excel)..." onkeyup="handleSearch()">
  ...
  <script>
    ...
    const quizQuestions = [
      ...
      { q: "3. Google Docs dasturining ish stoli (desktop) analogi qaysi?", options: ["A) Microsoft Word", "B) Adobe Photoshop", "C) WinRAR", "D) MS Access"], correct: 0 },
      ...
      { q: "6. Google Sheets dasturining ish stoli (desktop) analogi qaysi?", options: ["A) Microsoft Excel", "B) MS PowerPoint", "C) Google Chrome", "D) Paint"], correct: 0 },
      { q: "7. Telemeditsinada masofaviy konsilium o'tkazish servisi va uning analogi qaysi?", options: ["A) Google Meet (Analogi: Zoom)", "B) Google Docs", "C) Google Forms", "D) Google Calendar"], correct: 0 },
      { q: "8. Google Drive foydalanuvchilariga bepul qancha bulutli joy beradi?", options: ["A) 5 GB", "B) 10 GB", "C) 15 GB", "D) 50 GB"], correct: 2 },
      { q: "9. Google Drive dasturining bulutli analogi qaysi?", options: ["A) Microsoft OneDrive", "B) VLC Player", "C) Notepad", "D) MS Publisher"], correct: 0 },
      { q: "10. Google DeepMind oqsil strukturasini bashorat qiluvchi AI tizimi nima?", options: ["A) AlphaFold", "B) ChatGPT", "C) Google Translate", "D) TensorFlow"], correct: 0 },
      { q: "11. Shifokor qabul vaqtlarini rejalashtirish va uning Outlook analogi qaysi?", options: ["A) Google Calendar", "B) Google Drive", "C) Google Sheets", "D) Google Keep"], correct: 0 },
      { q: "12. Dori qabul qilish eslatmalari uchun va OneNote analogi bo'lgan servis qaysi?", options: ["A) Google Keep", "B) Google Slides", "C) Google Forms", "D) Google Meet"], correct: 0 },
      { q: "13. Google Docs hujjatini qaysi formatga eksport qilish mumkin?", options: ["A) PDF", "B) MP3", "C) EXE", "D) ZIP"], correct: 0 },
    ...
    const sections = [
      ...
      { id: "tahlil-dasturlar", title: "Dasturlar Tahlili & Analoglar" },
    ...
    function updateTaskProgress() {
      ...
      document.getElementById("taskStatusText").style.display = allChecked ? "flex" : "none";
    }
...
print("Generated no-emoji index.html with detailed app explanations and analogs successfully!")

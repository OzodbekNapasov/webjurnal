  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      background: radial-gradient(circle at 15% 15%, rgba(14, 165, 233, 0.15) 0%, transparent 45%),
                  radial-gradient(circle at 85% 85%, rgba(16, 185, 129, 0.15) 0%, transparent 45%),
                  var(--bg-main);
    ...
    .hero-logo-box {
      ...
      align-items: center;
      justify-content: center;
      box-shadow: 0 0 45px rgba(14, 165, 233, 0.38);
      animation: floatGlow 3.2s ease-in-out infinite alternate;
    }

    @keyframes floatGlow {
      0% { transform: translateY(0) scale(1); box-shadow: 0 0 30px rgba(14, 165, 233, 0.3); }
      100% { transform: translateY(-12px) scale(1.04); box-shadow: 0 0 55px rgba(16, 185, 129, 0.45); }
    }
...
<body>
  ...
  <main class="presentation-container">
    ...
    <div class="slides-wrapper">
      ...
      <section class="slide" data-slide="15">
        ...
        <h2 class="slide-title" style="justify-space-between;">
          ...
          <span id="quizScoreBadge" style="font-size:0.95rem; font-weight:800; color:var(--med-green);">Ball: 0 / 15</span>
        </h2>
        <div class="slide-content">
          <div id="quizContainer" style="display:flex; flex-direction:column; gap:12px; max-height:420px; overflow-y:auto;">
            <!-- Quiz questions rendered via JS -->
          </div>
      ...
      <section class="slide" data-slide="16">
        ...
        <div class="slide-content">
          <div class="grid-2" style="max-height:420px; overflow-y:auto;">
            <div class="glass-card"><strong>1. Google Nomi:</strong> "Googol" (1 raqami va undan keyingi 100 ta nol) matematik atamasidan olingan.</div>
  ...
  <script>
    ...
    // ==========================================
    // 6. EVENT LISTENERS (KEYBOARD & WHEEL & TOUCH)
    // ==========================================
...
print("Updated index.html successfully with touch gestures and refined features!")
